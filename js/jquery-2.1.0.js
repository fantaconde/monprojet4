	...
	function tb(a) {
		...
		return (
			c ||
				((c = sb(a, b)),
				("none" !== c && c) ||
					((qb = (qb || o("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement)),
		...
		for (var f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, g = 0; 4 > f; f += 2)
			"margin" === c && (g += o.css(a, c + R[f], !0, e)),
				d
					...
					: ((g += o.css(a, "padding" + R[f], !0, e)), "padding" !== c && (g += o.css(a, "border" + R[f] + "Width", !0, e)));
		return g;
	}
	function Ib(a, b, c) {
		var d = !0,
			...
			(d = a[g]),
				d.style &&
					...
					b
						...
						: f[g] || ((e = S(d)), ((c && "none" !== c) || !e) && L.set(d, "olddisplay", e ? c : o.css(d, "display"))));
		for (g = 0; h > g; g++)
			(d = a[g]),
							...
							(c = g[b]),
								...
								g !== d &&
									(j && d && (o.isPlainObject(d) || (e = o.isArray(d)))
										? (e ? ((e = !1), (f = c && o.isArray(c) ? c : [])) : (f = c && o.isPlainObject(c) ? c : {}),
										  (g[b] = o.extend(j, f, d)))
										: void 0 !== d && (g[b] = d));
				return g;
			}),
				...
				(a = o.trim(a)),
					a &&
						(1 === a.indexOf("use strict")
							? ((b = m.createElement("script")), (b.text = a), m.head.appendChild(b).parentNode.removeChild(b))
							: c(a));
			},
			...
			for (
				...
				if ((c = d.relative[a[j].type])) m = [qb(rb(m), c)];
					...
					if (((c = d.filter[a[j].type].apply(null, a[j].matches)), c[s])) {
						...
						return tb(
							j > 1 && rb(m),
							j > 1 && pb(a.slice(0, j - 1).concat({ value: " " === a[j - 2].type ? "*" : "" })).replace(P, "$1"),
							c,
							e > j && ub(a.slice(j, e)),
							f > e && ub((a = a.slice(e))),
							f > e && pb(a)
					...
					return e !== l && 9 === e.nodeType && e.documentElement
						? ((l = e),
						  ...
						  (c.matchesSelector = Y.test(
								(q = m.webkitMatchesSelector || m.mozMatchesSelector || m.oMatchesSelector || m.msMatchesSelector)
						  )) &&
								gb(function (a) {
		...
		A = (o.fn.init = function (a, b) {
			...
			return a.nodeType
				...
				? "undefined" != typeof y.ready
					? y.ready(a)
					: a(o)
				: (void 0 !== a.selector && ((this.selector = a.selector), (this.context = a.context)), o.makeArray(a, this));
		});
					...
					return (
						h &&
							o.each(arguments, function (a, b) {
								for (var c; (c = o.inArray(b, h, c)) > -1; ) h.splice(c, 1), d && (f >= c && f--, g >= c && g--);
							}),
						this
					);
				},
		...
		o.extend({
			...
			ready: function (a) {
				(a === !0 ? --o.readyWait : o.isReady) ||
					((o.isReady = !0),
					(a !== !0 && --o.readyWait > 0) || (H.resolveWith(m, [o]), o.fn.trigger && o(m).trigger("ready").off("ready")));
			},
		}),
			...
			remove: function (a, b) {
				...
				if (void 0 === b) this.cache[f] = {};
					...
					o.isArray(b)
						...
						: ((e = o.camelCase(b)), b in g ? (d = [b, e]) : ((d = e), (d = d in g ? [d] : d.match(E) || []))),
						(c = d.length);
					for (; c--; ) delete g[d[c]];
				}
			},
	...
	(o.event = {
			...
			if (r && (i = r.events)) {
				for (b = (b || "").match(E) || [""], j = b.length; j--; )
					if (((h = Y.exec(b[j]) || []), (n = q = h[1]), (p = (h[2] || "").split(".").sort()), n)) {
						...
						g &&
							!m.length &&
							((l.teardown && l.teardown.call(a, p, r.handle) !== !1) || o.removeEvent(a, n, r.handle), delete i[n]);
		...
		dispatch: function (a) {
			...
			if (((i[0] = a), (a.delegateTarget = this), !k.preDispatch || k.preDispatch.call(this, a) !== !1)) {
				for (h = o.event.handlers.call(this, a, j), b = 0; (f = h[b++]) && !a.isPropagationStopped(); )
				...
				? (a && a.type
						? ((this.originalEvent = a),
						  ...
						  (this.isDefaultPrevented =
								a.defaultPrevented || (void 0 === a.defaultPrevented && a.getPreventDefault && a.getPreventDefault())
									? Z
									: $))
						: (this.type = a),
				  b && o.extend(this, b),
	...
	(ib.optgroup = ib.option),
		...
		o.extend({
			...
			buildFragment: function (a, b, c, d) {
				...
				for (k.textContent = "", m = 0; (e = l[m++]); )
					if (
						(!d || -1 === o.inArray(e, d)) &&
						((i = o.contains(e.ownerDocument, e)), (f = ob(k.appendChild(e), "script")), i && mb(f), c)
					)
		...
		o.fn.extend({
			...
			domManip: function (a, b) {
				...
				if (
					k &&
					((c = o.buildFragment(a, this[0].ownerDocument, !1, this)), (d = c.firstChild), 1 === c.childNodes.length && (c = d), d)
				) {
						...
						for (i = f[f.length - 1].ownerDocument, o.map(f, lb), j = 0; g > j; j++)
							(h = f[j]),
								fb.test(h.type || "") &&
									...
									o.contains(i, h) &&
									(h.src ? o._evalUrl && o._evalUrl(h.src) : o.globalEval(h.textContent.replace(hb, "")));
				}
				return this;
			},
		}),
	...
	o.extend({
				...
				return (
					...
					void 0 === c
						? g && "get" in g && void 0 !== (e = g.get(a, !1, d))
							...
							: i[b]
						: ((f = typeof c),
						  "string" === f && (e = Bb.exec(c)) && ((c = (e[1] + 1) * e[2] + parseFloat(o.css(a, b))), (f = "number")),
						  void (
								null != c &&
								c === c &&
		...
		(Kb.prototype = {
			...
			run: function (a) {
				...
				return (
					(this.pos = b =
						this.options.duration ? o.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : a),
	...
	(o.Animation = o.extend(Xb, {
		...
		(o.speed = function (a, b, c) {
			var d =
				a && "object" == typeof a
					? o.extend({}, a)
					: { complete: c || (!c && b) || (o.isFunction(a) && a), duration: a, easing: (c && b) || (b && !o.isFunction(b) && b) };
			return (
				(d.duration = o.fx.off
					? 0
			...
			attr: function (a, b, c) {
				...
				return a && 3 !== f && 8 !== f && 2 !== f
					? typeof a.getAttribute === U
						? o.prop(a, b, c)
						: ((1 === f && o.isXMLDoc(a)) ||
								((b = b.toLowerCase()), (d = o.attrHooks[b] || (o.expr.match.bool.test(b) ? Zb : Yb))),
						  void 0 === c
			...
			return "boolean" == typeof b && "string" === c
				...
				: this.each(
						o.isFunction(a)
							...
							: function () {
									if ("string" === c)
										for (var b, d = 0, e = o(this), f = a.match(E) || []; (b = f[d++]); )
		...
		o.extend({
			valHooks: {
				select: {
					...
					set: function (a, b) {
						for (var c, d, e = a.options, f = o.makeArray(b), g = e.length; g--; )
	...
	(ec = mc.exec(fc.toLowerCase()) || []),
		...
		o.each(["get", "post"], function (a, b) {
			o[b] = function (a, c, d, e) {
				return (
					o.isFunction(c) && ((e = e || d), (d = c), (c = void 0)), o.ajax({ url: a, type: b, dataType: e, data: c, success: d })
				);
			};
		}),
			...
			serializeArray: function () {
				return this.map(function () {
					...
					.filter(function () {
						var a = this.type;
						return (
							this.name && !o(this).is(":disabled") && Ac.test(this.nodeName) && !zc.test(a) && (this.checked || !T.test(a))
						);
					})
					.map(function (a, b) {
						var c = o(this).val();
			...
			position: function () {
				if (this[0]) {
					...
					return (
						...
						{ top: b.top - d.top - o.css(c, "marginTop", !0), left: b.left - d.left - o.css(c, "marginLeft", !0) }
					);
				}
			},
			offsetParent: function () {
				return this.map(function () {
					for (var a = this.offsetParent || Jc; a && !o.nodeName(a, "html") && "static" === o.css(a, "position"); )
						a = a.offsetParent;
					return a || Jc;
				});
			},
